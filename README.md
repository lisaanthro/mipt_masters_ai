...
**Эксперименты** (ноутбук самодостаточен — обучает модели мира и прогоняет все три метода):

```bash
pip install "gymnasium>=1.0" "minigrid>=3.0" "transformers>=4.40" imageio torch
# открыть rssm_analysis.ipynb в Jupyter / Colab и выполнить ячейки
```
